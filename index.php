...
/* DESENHA GRAFICO DE LINHA - QUANTIDADE DE ACIDENTES FEMININO */

	  google.setOnLoadCallback(desenhaGraficoLinhaFeminino);
      function desenhaGraficoLinhaFeminino() {
		var data = google.visualization.arrayToDataTable([
    	['Ano', 'Ocorrencias'],
		<?php
        ...
        var options = {
          title: 'Quantidade de Acidentes do Sexo Feminino',
		  hAxis: {title: 'Período'}
        };

        var chart = new google.visualization.LineChart(document.getElementById('acidentes-feminino'));
        chart.draw(data, options);
      }



/* DESENHA GRAFICO DE LINHA - QUANTIDADE DE ACIDENTES MASCULINO */

      google.setOnLoadCallback(desenhaGraficoLinhaMasculino);
      function desenhaGraficoLinhaMasculino() {
		var data = google.visualization.arrayToDataTable([
    	['Ano', 'Ocorrencias'],
		<?php
        ...
        var options = {
          title: 'Quantidade de Acidentes do Sexo Masculino',
		  hAxis: {title: 'Período'},
		  
        };

        var chart = new google.visualization.LineChart(document.getElementById('acidentes-masculino'));
        chart.draw(data, options);
      }
</script>
  ...
  <div id="featured_slide">
    <div id="featured_wrap">    
      <ul id="featured_tabs">
        ...
        <li><a href="#fc2">Base de Dados Livre</a></li>        
        ...
        <div id="table-uf" style="margin-left:20px; ">
            ...
            <div id="area-grafico">
            	...
            	<div class="pizza" style="float:left;">
            		<div id="acidentes-feminino" style="width: 400px; height: 230px;"></div>
            	</div>
				 
            	<div class="pizza" style="float:right;">
            		<div id="acidentes-masculino" style="width: 400px; height: 230px;"></div>
           		</div>			
    	...
    	<h2></h2>     
      	<ul>
        	<li class="last">
        		...
        		<a href="http://www.gnu.org/licenses/licenses.pt-br.html" target="_blank" >
    	...
    	<h2></h2>
      	<ul>
        	<li class="last">
        		...
        		<a href="https://github.com/jaimefelixof/branalise" target="_blank" >
